...
STRINGS = {
    "en": {
        ...
        "days_range": "Days of the month",
        "days_range_help": "Only search these days of the selected month.",
        "days_range_caption": "Searching days {start}–{end} of {month}",
    ...
    "es": {
        ...
        "days_range": "Días del mes",
        "days_range_help": "Solo busca estos días del mes seleccionado.",
        "days_range_caption": "Buscar los días {start}–{end} de {month}",
